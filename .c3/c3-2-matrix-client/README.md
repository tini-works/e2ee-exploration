---
id: c3-2
c3-seal: 9b84857e9e7c74591fb62e550658e681d60d10730cc15aff45b39592c5cea80d
title: matrix-client
type: container
boundary: service
parent: c3-0
...
| c3-211 | matrix-provider | feature | active | React lifecycle, sync state, recovery-key gate, signIn/signOut. |
...
- Expose React lifecycle via `MatrixProvider` + `useMatrix()`; gate `ready` on sync state + `keyUnlockedThisSession`.
